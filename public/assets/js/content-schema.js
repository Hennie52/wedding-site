...
window.CONTENT_SCHEMA = [
  ...
  { key:"verblyf_plek_kicker", label:"Ligging — bo-etiket", type:"text", group:"Verblyf", default:"Die ligging" },
  { key:"verblyf_plek_naam", label:"Ligging — pleknaam", type:"text", group:"Verblyf", default:"Kuthaba Bush Lodge" },
  { key:"verblyf_plek_info", label:"Ligging — beskrywing", type:"textarea", group:"Verblyf",
    default:"Alles gebeur hier — die seremonie, onthaal en verblyf. Kry maklik aanwysings met die kaart." },
  { key:"verblyf_map_btn", label:"Ligging — knoppie-teks", type:"text", group:"Verblyf", default:"Maak oop in Google Maps" },
  { key:"verblyf_map_url", label:"Ligging — Google Maps-skakel", type:"text", group:"Verblyf",
    default:"https://maps.app.goo.gl/gZF3QCAfxfjxTD9e6",
  ...
  { key:"rsvp_q_epos", label:"RSVP-vraag: e-posadres", type:"text", group:"RSVP", default:"Jou e-posadres",
    help:"Verpligtend wanneer 'n gas kom — sodat jy hulle kan bereik." },
  ...
  { key:"rsvp_ph_epos", label:"RSVP — plekhouer: e-pos", type:"text", group:"RSVP", default:"naam@voorbeeld.co.za" },
